    ...
    <div class="bottom-navigation-bar">
        <div class="tf-container">
            <ul class="tf-navigation-bar">
                ...
                <li class="{{ Request::is('my-dina-luar*') ? 'active' : '' }}"><a class="fw_4 d-flex justify-content-center align-items-center flex-column"
                        ...
                        Dinas</a> </li>
                <li class="{{ Request::is('my-lembur*') ? 'active' : '' }}"><a class="fw_4 d-flex justify-content-center align-items-center flex-column" href="{{ url('/my-lembur') }}"><i
                            class="icon-user-outline"></i> Lembur</a> </li>
            </ul>
        </div>
    </div>
